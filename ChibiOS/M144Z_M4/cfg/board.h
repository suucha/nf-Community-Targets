...
#define GPIOC_RMII_ETH_MDC          1U
#define GPIOC_PIN2                  2U
#define GPIOC_PDM_OUT               3U
#define GPIOC_RMII_ETH_RXD0         4U
#define GPIOC_RMII_ETH_RXD1         5U
...
#define GPIOD_RMII_ETH_RESET        3U
...
#define GPIOG_RMII_ETH_TX_EN        11U
#define GPIOG_PIN12                 12U
#define GPIOG_RMII_ETH_TXD0         13U
#define GPIOG_RMII_ETH_TXD1         14U
...
#define LINE_RMII_ETH_MDC           PAL_LINE(GPIOC, 1U)
#define LINE_PDM_OUT                PAL_LINE(GPIOC, 3U)
#define LINE_RMII_ETH_RXD0          PAL_LINE(GPIOC, 4U)
#define LINE_RMII_ETH_RXD1          PAL_LINE(GPIOC, 5U)
#define LINE_OSC32_IN               PAL_LINE(GPIOC, 14U)
#define LINE_OSC32_OUT              PAL_LINE(GPIOC, 15U)
#define LINE_FSMC_D2                PAL_LINE(GPIOD, 0U)
#define LINE_FSMC_D3                PAL_LINE(GPIOD, 1U)
#define LINE_RMII_ETH_RESET         PAL_LINE(GPIOD, 3U)
...
#define LINE_BEEP                   PAL_LINE(GPIOF, 8U)
...
#define LINE_RMII_ETH_TX_EN         PAL_LINE(GPIOG, 11U)
#define LINE_RMII_ETH_TXD0          PAL_LINE(GPIOG, 13U)
#define LINE_RMII_ETH_TXD1          PAL_LINE(GPIOG, 14U)
 ...
 * PB8  - IIC_SCL                   (output pushpull maximum).
 * PB9  - IIC_SDA                   (output pushpull maximum).
...
#define VAL_GPIOB_MODER             (PIN_MODE_INPUT(GPIOB_PIN0) |           \
                                     ...
                                     PIN_MODE_OUTPUT(GPIOB_IIC_SCL) |       \
                                     PIN_MODE_OUTPUT(GPIOB_IIC_SDA) |       \
...
#define VAL_GPIOB_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOB_PIN0) |       \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOB_IIC_SCL) |    \
                                     PIN_OTYPE_PUSHPULL(GPIOB_IIC_SDA) |    \
...
#define VAL_GPIOB_PUPDR             (PIN_PUPDR_PULLUP(GPIOB_PIN0) |         \
                                     ...
                                     PIN_PUPDR_PULLUP(GPIOB_IIC_SCL) |      \
                                     PIN_PUPDR_PULLUP(GPIOB_IIC_SDA) |      \
...
#define VAL_GPIOB_AFRH              (PIN_AFIO_AF(GPIOB_IIC_SCL, 0U) |       \
                                     PIN_AFIO_AF(GPIOB_IIC_SDA, 0U) |       \
 ...
 * PC1  - RMII_ETH_MDC              (alternate 11).
 * PC2  - PIN2                      (input pullup).
 * PC3  - PDM_OUT                   (input pullup).
 * PC4  - RMII_ETH_RXD0             (alternate 11).
 * PC5  - RMII_ETH_RXD1             (alternate 11).
...
#define VAL_GPIOC_MODER             (PIN_MODE_OUTPUT(GPIOC_PIN0) |          \
                                     PIN_MODE_ALTERNATE(GPIOC_RMII_ETH_MDC) |\
                                     PIN_MODE_INPUT(GPIOC_PIN2) |           \
                                     PIN_MODE_INPUT(GPIOC_PDM_OUT) |        \
                                     PIN_MODE_ALTERNATE(GPIOC_RMII_ETH_RXD0) |\
                                     PIN_MODE_ALTERNATE(GPIOC_RMII_ETH_RXD1) |\
...
#define VAL_GPIOC_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOC_PIN0) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOC_RMII_ETH_MDC) |\
                                     PIN_OTYPE_PUSHPULL(GPIOC_PIN2) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOC_PDM_OUT) |    \
                                     PIN_OTYPE_PUSHPULL(GPIOC_RMII_ETH_RXD0) |\
                                     PIN_OTYPE_PUSHPULL(GPIOC_RMII_ETH_RXD1) |\
...
#define VAL_GPIOC_OSPEEDR           (PIN_OSPEED_HIGH(GPIOC_PIN0) |          \
                                     PIN_OSPEED_HIGH(GPIOC_RMII_ETH_MDC) |  \
                                     PIN_OSPEED_HIGH(GPIOC_PIN2) |          \
                                     PIN_OSPEED_HIGH(GPIOC_PDM_OUT) |       \
                                     PIN_OSPEED_HIGH(GPIOC_RMII_ETH_RXD0) | \
                                     PIN_OSPEED_HIGH(GPIOC_RMII_ETH_RXD1) | \
...
#define VAL_GPIOC_PUPDR             (PIN_PUPDR_FLOATING(GPIOC_PIN0) |       \
                                     PIN_PUPDR_FLOATING(GPIOC_RMII_ETH_MDC) |\
                                     PIN_PUPDR_PULLUP(GPIOC_PIN2) |         \
                                     PIN_PUPDR_PULLUP(GPIOC_PDM_OUT) |      \
                                     PIN_PUPDR_FLOATING(GPIOC_RMII_ETH_RXD0) |\
                                     PIN_PUPDR_FLOATING(GPIOC_RMII_ETH_RXD1) |\
...
#define VAL_GPIOC_ODR               (PIN_ODR_HIGH(GPIOC_PIN0) |             \
                                     PIN_ODR_HIGH(GPIOC_RMII_ETH_MDC) |     \
                                     PIN_ODR_HIGH(GPIOC_PIN2) |             \
                                     PIN_ODR_HIGH(GPIOC_PDM_OUT) |          \
                                     PIN_ODR_HIGH(GPIOC_RMII_ETH_RXD0) |    \
                                     PIN_ODR_HIGH(GPIOC_RMII_ETH_RXD1) |    \
...
#define VAL_GPIOC_AFRL              (PIN_AFIO_AF(GPIOC_PIN0, 0U) |          \
                                     PIN_AFIO_AF(GPIOC_RMII_ETH_MDC, 11U) | \
                                     PIN_AFIO_AF(GPIOC_PIN2, 0U) |          \
                                     PIN_AFIO_AF(GPIOC_PDM_OUT, 0U) |       \
                                     PIN_AFIO_AF(GPIOC_RMII_ETH_RXD0, 11U) |\
                                     PIN_AFIO_AF(GPIOC_RMII_ETH_RXD1, 11U) |\
 ...
 * PD3  - RMII_ETH_RESET            (output pushpull maximum).
...
#define VAL_GPIOD_MODER             (PIN_MODE_ALTERNATE(GPIOD_FSMC_D2) |    \
                                     ...
                                     PIN_MODE_OUTPUT(GPIOD_RMII_ETH_RESET) |\
...
#define VAL_GPIOD_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOD_FSMC_D2) |    \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOD_RMII_ETH_RESET) |\
...
#define VAL_GPIOD_OSPEEDR           (PIN_OSPEED_HIGH(GPIOD_FSMC_D2) |       \
                                     ...
                                     PIN_OSPEED_HIGH(GPIOD_RMII_ETH_RESET) |\
...
#define VAL_GPIOD_PUPDR             (PIN_PUPDR_PULLUP(GPIOD_FSMC_D2) |      \
                                     ...
                                     PIN_PUPDR_FLOATING(GPIOD_RMII_ETH_RESET) |\
                                     PIN_PUPDR_PULLUP(GPIOD_FSMC_NOE) |     \
                                     PIN_PUPDR_PULLUP(GPIOD_FSMC_NWE) |     \
                                     PIN_PUPDR_PULLUP(GPIOD_PIN6) |         \
                                     PIN_PUPDR_PULLUP(GPIOD_PIN7) |         \
                                     PIN_PUPDR_PULLUP(GPIOD_FSMC_D13) |     \
                                     PIN_PUPDR_PULLUP(GPIOD_FSMC_D14) |     \
                                     PIN_PUPDR_PULLUP(GPIOD_FSMC_D15) |     \
                                     PIN_PUPDR_PULLUP(GPIOD_FSMC_A16) |     \
                                     PIN_PUPDR_PULLUP(GPIOD_FSMC_A17) |     \
                                     PIN_PUPDR_PULLUP(GPIOD_FSMC_A18) |     \
                                     PIN_PUPDR_PULLUP(GPIOD_FSMC_D0) |      \
                                     PIN_PUPDR_PULLUP(GPIOD_FSMC_D1))
#define VAL_GPIOD_ODR               (PIN_ODR_HIGH(GPIOD_FSMC_D2) |          \
                                     PIN_ODR_HIGH(GPIOD_FSMC_D3) |          \
                                     PIN_ODR_HIGH(GPIOD_PIN2) |             \
                                     PIN_ODR_HIGH(GPIOD_RMII_ETH_RESET) |   \
...
#define VAL_GPIOD_AFRL              (PIN_AFIO_AF(GPIOD_FSMC_D2, 12U) |      \
                                     ...
                                     PIN_AFIO_AF(GPIOD_RMII_ETH_RESET, 0U) |\
...
#define VAL_GPIOE_PUPDR             (PIN_PUPDR_PULLUP(GPIOE_FSMC_NBL0) |    \
                                     PIN_PUPDR_PULLUP(GPIOE_FSMC_NBL1) |    \
                                     PIN_PUPDR_FLOATING(GPIOE_PIN2) |       \
                                     PIN_PUPDR_FLOATING(GPIOE_PIN3) |       \
                                     PIN_PUPDR_FLOATING(GPIOE_PIN4) |       \
                                     PIN_PUPDR_FLOATING(GPIOE_PIN5) |       \
                                     PIN_PUPDR_FLOATING(GPIOE_PIN6) |       \
                                     PIN_PUPDR_PULLUP(GPIOE_FSMC_D4) |      \
                                     PIN_PUPDR_PULLUP(GPIOE_FSMC_D5) |      \
                                     PIN_PUPDR_PULLUP(GPIOE_FSMC_D6) |      \
                                     PIN_PUPDR_PULLUP(GPIOE_FSMC_D7) |      \
                                     PIN_PUPDR_PULLUP(GPIOE_FSMC_D8) |      \
                                     PIN_PUPDR_PULLUP(GPIOE_FSMC_D9) |      \
                                     PIN_PUPDR_PULLUP(GPIOE_FSMC_D10) |     \
                                     PIN_PUPDR_PULLUP(GPIOE_FSMC_D11) |     \
                                     PIN_PUPDR_PULLUP(GPIOE_FSMC_D12))
 ...
 * PF8  - BEEP                      (output pushpull maximum).
...
#define VAL_GPIOF_PUPDR             (PIN_PUPDR_PULLUP(GPIOF_FSMC_A0) |      \
                                     PIN_PUPDR_PULLUP(GPIOF_FSMC_A1) |      \
                                     PIN_PUPDR_PULLUP(GPIOF_FSMC_A2) |      \
                                     PIN_PUPDR_PULLUP(GPIOF_FSMC_A3) |      \
                                     PIN_PUPDR_PULLUP(GPIOF_FSMC_A4) |      \
                                     PIN_PUPDR_PULLUP(GPIOF_FSMC_A5) |      \
                                     PIN_PUPDR_FLOATING(GPIOF_PIN6) |       \
                                     PIN_PUPDR_FLOATING(GPIOF_PIN7) |       \
                                     PIN_PUPDR_PULLUP(GPIOF_BEEP) |         \
                                     PIN_PUPDR_PULLUP(GPIOF_LED_RED) |      \
                                     PIN_PUPDR_PULLUP(GPIOF_LED_GREEN) |    \
                                     PIN_PUPDR_FLOATING(GPIOF_PIN11) |      \
                                     PIN_PUPDR_PULLUP(GPIOF_FSMC_A6) |      \
                                     PIN_PUPDR_PULLUP(GPIOF_FSMC_A7) |      \
                                     PIN_PUPDR_PULLUP(GPIOF_FSMC_A8) |      \
                                     PIN_PUPDR_PULLUP(GPIOF_FSMC_A9))
...
#define VAL_GPIOF_AFRH              (PIN_AFIO_AF(GPIOF_BEEP, 0U) |          \
 ...
 * PG11 - RMII_ETH_TX_EN            (alternate 11).
 * PG12 - PIN12                     (input floating).
 * PG13 - RMII_ETH_TXD0             (alternate 11).
 * PG14 - RMII_ETH_TXD1             (alternate 11).
...
#define VAL_GPIOG_MODER             (PIN_MODE_ALTERNATE(GPIOG_FSMC_A10) |   \
                                     ...
                                     PIN_MODE_ALTERNATE(GPIOG_RMII_ETH_TX_EN) |\
                                     PIN_MODE_INPUT(GPIOG_PIN12) |          \
                                     PIN_MODE_ALTERNATE(GPIOG_RMII_ETH_TXD0) |\
                                     PIN_MODE_ALTERNATE(GPIOG_RMII_ETH_TXD1) |\
...
#define VAL_GPIOG_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOG_FSMC_A10) |   \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOG_RMII_ETH_TX_EN) |\
                                     PIN_OTYPE_PUSHPULL(GPIOG_PIN12) |      \
                                     PIN_OTYPE_PUSHPULL(GPIOG_RMII_ETH_TXD0) |\
                                     PIN_OTYPE_PUSHPULL(GPIOG_RMII_ETH_TXD1) |\
...
#define VAL_GPIOG_OSPEEDR           (PIN_OSPEED_HIGH(GPIOG_FSMC_A10) |      \
                                     ...
                                     PIN_OSPEED_HIGH(GPIOG_RMII_ETH_TX_EN) |\
                                     PIN_OSPEED_HIGH(GPIOG_PIN12) |         \
                                     PIN_OSPEED_HIGH(GPIOG_RMII_ETH_TXD0) | \
                                     PIN_OSPEED_HIGH(GPIOG_RMII_ETH_TXD1) | \
                                     PIN_OSPEED_HIGH(GPIOG_PIN15))
#define VAL_GPIOG_PUPDR             (PIN_PUPDR_PULLUP(GPIOG_FSMC_A10) |     \
                                     PIN_PUPDR_PULLUP(GPIOG_FSMC_A11) |     \
                                     PIN_PUPDR_PULLUP(GPIOG_FSMC_A12) |     \
                                     PIN_PUPDR_PULLUP(GPIOG_FSMC_A13) |     \
                                     PIN_PUPDR_PULLUP(GPIOG_FSMC_A14) |     \
                                     PIN_PUPDR_PULLUP(GPIOG_FSMC_A15) |     \
                                     PIN_PUPDR_FLOATING(GPIOG_PIN6) |       \
                                     PIN_PUPDR_FLOATING(GPIOG_PIN7) |       \
                                     PIN_PUPDR_FLOATING(GPIOG_PIN8) |       \
                                     PIN_PUPDR_FLOATING(GPIOG_PIN9) |       \
                                     PIN_PUPDR_PULLUP(GPIOG_FSMC_NE3) |     \
                                     PIN_PUPDR_FLOATING(GPIOG_RMII_ETH_TX_EN) |\
                                     PIN_PUPDR_FLOATING(GPIOG_PIN12) |      \
                                     PIN_PUPDR_FLOATING(GPIOG_RMII_ETH_TXD0) |\
                                     PIN_PUPDR_FLOATING(GPIOG_RMII_ETH_TXD1) |\
...
#define VAL_GPIOG_ODR               (PIN_ODR_HIGH(GPIOG_FSMC_A10) |         \
                                     ...
                                     PIN_ODR_HIGH(GPIOG_RMII_ETH_TX_EN) |   \
                                     PIN_ODR_HIGH(GPIOG_PIN12) |            \
                                     PIN_ODR_HIGH(GPIOG_RMII_ETH_TXD0) |    \
                                     PIN_ODR_HIGH(GPIOG_RMII_ETH_TXD1) |    \
...
#define VAL_GPIOG_AFRH              (PIN_AFIO_AF(GPIOG_PIN8, 0U) |          \
                                     ...
                                     PIN_AFIO_AF(GPIOG_RMII_ETH_TX_EN, 11U) |\
                                     PIN_AFIO_AF(GPIOG_PIN12, 0U) |         \
                                     PIN_AFIO_AF(GPIOG_RMII_ETH_TXD0, 11U) |\
                                     PIN_AFIO_AF(GPIOG_RMII_ETH_TXD1, 11U) |\
